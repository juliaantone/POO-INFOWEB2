...
class ManterHorariosUI:
    def main():
        ...
        with tab1: ManterHorariosUI.listar()
        with tab2: ManterHorariosUI.inserir()
        with tab3: ManterHorariosUI.atualizar()
        with tab4: ManterHorariosUI.excluir()
    ...
    def inserir():
        ...
        if st.button("Inserir"):
            ...
            Service.horario_inserir(datetime.strptime(data, "%d/%m/%Y %H:%M"),
